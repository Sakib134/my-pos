<?php $__env->startSection('title',\App\CPU\translate('Employee_Add')); ?>
...
<div class="content container-fluid">
    <div class="row align-items-center mb-3">
        <div class="col-sm mb-2 mb-sm-0">
            <h1 class="page-header-title d-flex align-items-center g-2px text-capitalize"><i
                    class="tio-add-circle-outlined"></i><?php echo e(\App\CPU\translate('Add_New_Employee')); ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card p-3">
                <form action="<?php echo e(route('admin.employee.add-new')); ?>" method="post"  class="js-validate" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="card mb-3">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" name="f_name" class="form-control h--45px" id="fname"
                                                       placeholder="<?php echo e(\App\CPU\translate('Ex:_John')); ?>" value="<?php echo e(old('f_name')); ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" name="l_name" class="form-control h--45px" id="lname" value="<?php echo e(old('l_name')); ?>"
                                                       placeholder="<?php echo e(\App\CPU\translate('Ex:_Doe')); ?>" value="<?php echo e(old('name')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group mb-0">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" name="phone" value="<?php echo e(old('phone')); ?>" class="form-control h--45px" id="phone"
                                                       ...
                                                       placeholder="<?php echo e(\App\CPU\translate('Ex:_+8801******')); ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-4 col-md-6">
                                <h5 class="card-header-title">
                                    <span><?php echo e(\App\CPU\translate('employee_table')); ?></span>
                                    <span class="badge badge-soft-dark ml-2"><?php echo e($employees->total()); ?></span>
                                </h5>
                                ...
                                <form action="<?php echo e(url()->current()); ?>" method="GET">
                                    <div class="input-group input-group-merge input-group-flush">
                                        ...
                                        <input id="datatableSearch_" type="search" name="search" class="form-control"
                                               placeholder="<?php echo e(\App\CPU\translate('search_by_name_or_email_or_phone')); ?>" aria-label="Search" value="<?php echo e($search); ?>" required>
                ...
                <div class="table-responsive ">
                    <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table mb-4">
                        ...
                        <tr>
                            ...
                            <th><?php echo e(\App\CPU\translate('Employee Name')); ?></th>
                            <th><?php echo e(\App\CPU\translate('phone')); ?></th>
                            <th><?php echo e(\App\CPU\translate('email')); ?></th>
                            <th class="text-center w-120px"><?php echo e(\App\CPU\translate('action')); ?></th>
                        </tr>
                        </thead>
                        <tbody id="set-rows">
                        <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <th scope="row"><?php echo e($key+$employees->firstItem()); ?></th>
                                    ...
                                    <?php if(auth('admin')->id()  != $employee['id']): ?>
                                        <div class="btn--container">
                                            <a class="btn btn-sm btn--primary btn-outline-primary action-btn"
                                               href="<?php echo e(route('admin.employee.edit',[$employee['id']])); ?>" title="<?php echo e(\App\CPU\translate('edit_Employee')); ?>"><i class="tio-edit"></i>
                                            </a>
                                            <a class="btn btn-sm btn--danger btn-outline-danger action-btn" href="javascript:"
                                               onclick="form_alert('employee-<?php echo e($employee['id']); ?>','<?php echo e(\App\CPU\translate('Want_to_delete_this_employee_?')); ?>')" title="<?php echo e(\App\CPU\translate('delete_Employee')); ?>"><i class="tio-delete-outlined"></i>
                                            </a>
                                        </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sites/37b/8/88e140d5f0/public_lmm/pos/resources/views/admin-views/employee/add-new.blade.php ENDPATH**/ ?>